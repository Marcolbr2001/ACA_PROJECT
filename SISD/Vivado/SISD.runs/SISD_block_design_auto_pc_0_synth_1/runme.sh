...
HD_PWD='C:/Users/lotto/Desktop/Alveare/SISD/SISD/SISD.runs/SISD_block_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SISD_block_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SISD_block_design_auto_pc_0.tcl

...
HD_PWD='C:/Users/lotto/Desktop/Alveare/SISD/SISD/SISD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SISD_block_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SISD_block_design_wrapper.tcl

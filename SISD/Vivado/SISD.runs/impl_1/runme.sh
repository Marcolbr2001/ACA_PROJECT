...
HD_PWD='C:/Users/lotto/Desktop/Alveare/SISD/SISD/SISD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SISD_block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SISD_block_design_wrapper.tcl -notrace

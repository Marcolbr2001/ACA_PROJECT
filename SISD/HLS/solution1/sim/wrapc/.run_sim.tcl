...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sisd.autotvin.dat"
	set constFileTvOut       "sisd.autotvout.dat"
	set constFileHdlTvIn     "sisd.autohdltvin.dat"
	set constFileHdlTvOut    "sisd.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

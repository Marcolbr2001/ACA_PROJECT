...
HD_PWD='C:/Users/marco/Desktop/M_AXI_ALU/M_AXI_ALU/template/template.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alv_MIMD_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alv_MIMD_BD_wrapper.tcl -notrace

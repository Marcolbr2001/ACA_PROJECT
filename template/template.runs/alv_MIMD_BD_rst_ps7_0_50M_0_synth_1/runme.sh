...
HD_PWD='C:/Users/marco/Desktop/M_AXI_ALU/M_AXI_ALU/template/template.runs/alv_MIMD_BD_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alv_MIMD_BD_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alv_MIMD_BD_rst_ps7_0_50M_0.tcl

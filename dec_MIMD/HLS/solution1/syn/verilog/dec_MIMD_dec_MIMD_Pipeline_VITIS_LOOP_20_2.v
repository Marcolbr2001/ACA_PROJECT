...
module dec_MIMD_dec_MIMD_Pipeline_VITIS_LOOP_20_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [63:0] sext_ln22_fu_145_p1;
reg   [5:0] i_1_fu_62;
wire   [5:0] add_ln20_fu_111_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_i;
wire   [7:0] shl_ln1_fu_117_p3;
wire   [63:0] zext_ln22_fu_125_p1;
wire   [63:0] add_ln22_fu_129_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln20_fu_105_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln20_fu_105_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign ALU_operation_address0 = zext_ln20_fu_160_p1;

assign ALU_operation_d0 = gmem3_addr_read_reg_186;

assign add_ln20_fu_111_p2 = (ap_sig_allocacmp_i + 6'd1);

assign add_ln22_fu_129_p2 = (zext_ln22_fu_125_p1 + op);
...
assign icmp_ln20_fu_105_p2 = ((ap_sig_allocacmp_i == 6'd50) ? 1'b1 : 1'b0);
...
assign sext_ln22_fu_145_p1 = $signed(trunc_ln2_fu_135_p4);

assign shl_ln1_fu_117_p3 = {{ap_sig_allocacmp_i}, {2'd0}};

assign trunc_ln2_fu_135_p4 = {{add_ln22_fu_129_p2[63:2]}};

assign zext_ln20_fu_160_p1 = i_reg_171_pp0_iter9_reg;

assign zext_ln22_fu_125_p1 = shl_ln1_fu_117_p3;

endmodule //dec_MIMD_dec_MIMD_Pipeline_VITIS_LOOP_20_2

...
HLS_SOURCES = ../../../test_core.c ../../../core.c
...
$(ObjDir)/test_core.o: ../../../test_core.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../test_core.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/test_core.d

$(ObjDir)/core.o: ../../../core.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../core.c in $(BuildMode) mode" $(AVE_DIR_DLOG)

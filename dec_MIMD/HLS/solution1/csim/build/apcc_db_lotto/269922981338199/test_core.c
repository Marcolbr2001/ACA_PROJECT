...
printf("\n = 0x%X\n", 2u);
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = add nsw i32 %%storemerge420, 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_165_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__49);
if (AESL_DEBUG_TRACE)
printf("\n  %%59 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([46 x i8]* @aesl_internal_.str1, i64 0, i64 0), i32 %%52, i32 %%54, i32 %%56, i32 %%58, i32 5) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_246_count);
  printf(( char *)((&aesl_internal__OC_str1[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 46
#endif
])), llvm_cbe_tmp__43, llvm_cbe_tmp__45, llvm_cbe_tmp__47, llvm_cbe_tmp__49, 5u);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__81:
if (AESL_DEBUG_TRACE)
printf("\n  call void @dec_MIMD(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 2) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_298_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @dec_MIMD(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 5) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_330_count);
  dec_MIMD((signed int *)llvm_cbe_tmp__8, (signed int *)llvm_cbe_tmp__9, (signed int *)llvm_cbe_tmp__10, (signed int *)llvm_cbe_tmp__11, 5u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",5u);
}
...
printf("\n = 0x%X\n", llvm_cbe_tmp__67);
if (AESL_DEBUG_TRACE)
printf("\n  %%81 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([46 x i8]* @aesl_internal_.str1, i64 0, i64 0), i32 %%74, i32 %%76, i32 %%78, i32 %%80, i32 5) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_348_count);
  printf(( char *)((&aesl_internal__OC_str1[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 46
#endif
])), llvm_cbe_tmp__61, llvm_cbe_tmp__63, llvm_cbe_tmp__65, llvm_cbe_tmp__67, 5u);
if (AESL_DEBUG_TRACE) {

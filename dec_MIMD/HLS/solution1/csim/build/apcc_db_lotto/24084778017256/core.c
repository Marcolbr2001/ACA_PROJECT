...
signed int load_operations();
signed int write_output();
...
printf("\n = 0x%X\n", llvm_cbe_tmp__107);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = call i32 bitcast (i32 (...)* @load_operations to i32 (i32, i32*, i32*)*)(i32 %%3, i32* %%op, i32* getelementptr inbounds ([50 x i32]* @aesl_internal_dec_MIMD.ALU_operation, i64 0, i64 0)) nounwind, !dbg !8 for 0x%I64xth hint within @dec_MIMD  --> \n", ++aesl_llvm_cbe_291_count);
  load_operations(llvm_cbe_tmp__107, (signed int *)llvm_cbe_op, (signed int *)((&aesl_internal_dec_MIMD_OC_ALU_operation[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 50
#endif
])));
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = load volatile i32* %%1, align 4, !dbg !7 for 0x%I64xth hint within @dec_MIMD  --> \n", ++aesl_llvm_cbe_293_count);
  llvm_cbe_tmp__109 = (unsigned int )*((unsigned int volatile*)(&llvm_cbe_tmp__105));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__109);
if (AESL_DEBUG_TRACE)
printf("\n  call void @load_data_and_op(i32 %%5, i32* %%a, i32* %%b, i32* %%op, i32* getelementptr inbounds ([50 x i32]* @aesl_internal_dec_MIMD.data_a, i64 0, i64 0), i32* getelementptr inbounds ([50 x i32]* @aesl_internal_dec_MIMD.data_b, i64 0, i64 0), i32* getelementptr inbounds ([50 x i32]* @aesl_internal_dec_MIMD.ALU_operation, i64 0, i64 0)), !dbg !7 for 0x%I64xth hint within @dec_MIMD  --> \n", ++aesl_llvm_cbe_294_count);
  load_data_and_op(llvm_cbe_tmp__109, (signed int *)llvm_cbe_a, (signed int *)llvm_cbe_b, (signed int *)llvm_cbe_op, (signed int *)((&aesl_internal_dec_MIMD_OC_data_a[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 50
#endif
])), (signed int *)((&aesl_internal_dec_MIMD_OC_data_b[(((signed long long )0ull))
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load volatile i32* %%1, align 4, !dbg !8 for 0x%I64xth hint within @dec_MIMD  --> \n", ++aesl_llvm_cbe_296_count);
  llvm_cbe_tmp__110 = (unsigned int )*((unsigned int volatile*)(&llvm_cbe_tmp__105));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__110);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds [50 x i32]* %%data_result, i64 0, i64 0, !dbg !8 for 0x%I64xth hint within @dec_MIMD  --> \n", ++aesl_llvm_cbe_297_count);
  llvm_cbe_tmp__111 = (signed int *)(&llvm_cbe_data_result[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 50
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @execute(i32 %%6, i32* getelementptr inbounds ([50 x i32]* @aesl_internal_dec_MIMD.data_a, i64 0, i64 0), i32* getelementptr inbounds ([50 x i32]* @aesl_internal_dec_MIMD.data_b, i64 0, i64 0), i32* getelementptr inbounds ([50 x i32]* @aesl_internal_dec_MIMD.ALU_operation, i64 0, i64 0), i32* %%7), !dbg !8 for 0x%I64xth hint within @dec_MIMD  --> \n", ++aesl_llvm_cbe_298_count);
  execute(llvm_cbe_tmp__110, (signed int *)((&aesl_internal_dec_MIMD_OC_data_a[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 50
#endif
])), (signed int *)((&aesl_internal_dec_MIMD_OC_data_b[(((signed long long )0ull))
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load volatile i32* %%1, align 4, !dbg !7 for 0x%I64xth hint within @dec_MIMD  --> \n", ++aesl_llvm_cbe_300_count);
  llvm_cbe_tmp__112 = (unsigned int )*((unsigned int volatile*)(&llvm_cbe_tmp__105));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__112);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = call i32 bitcast (i32 (...)* @write_output to i32 (i32, i32*, i32*)*)(i32 %%8, i32* %%7, i32* %%c) nounwind, !dbg !7 for 0x%I64xth hint within @dec_MIMD  --> \n", ++aesl_llvm_cbe_301_count);
  write_output(llvm_cbe_tmp__112, (signed int *)llvm_cbe_tmp__111, (signed int *)llvm_cbe_c);
if (AESL_DEBUG_TRACE) {

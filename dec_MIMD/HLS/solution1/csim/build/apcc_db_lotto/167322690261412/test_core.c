...
printf("\n = 0x%X\n", llvm_cbe_tmp__56);
if (AESL_DEBUG_TRACE)
printf("\n  %%68 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([46 x i8]* @aesl_internal_.str1, i64 0, i64 0), i32 %%61, i32 %%63, i32 %%65, i32 %%67, i32 2) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_191_count);
  printf(( char *)((&aesl_internal__OC_str1[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 46
#endif
])), llvm_cbe_tmp__50, llvm_cbe_tmp__52, llvm_cbe_tmp__54, llvm_cbe_tmp__56, 2u);
if (AESL_DEBUG_TRACE) {

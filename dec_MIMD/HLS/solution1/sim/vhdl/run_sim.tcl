...
if {[file isfile dec_MIMD.autotvin.dat]} {
	file delete -force dec_MIMD.autotvin.dat
}

if {[file isfile dec_MIMD.autotvout.dat]} {
	file delete -force dec_MIMD.autotvout.dat
}

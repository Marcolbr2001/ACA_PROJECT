...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%storemerge24, i32* %%3, align 4, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_14_count);
  *llvm_cbe_tmp__2 = llvm_cbe_storemerge24;
if (AESL_DEBUG_TRACE)
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_dec_MIMD_sw(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 2) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_45_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%storemerge320, i32* %%29, align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_82_count);
  *llvm_cbe_tmp__24 = llvm_cbe_storemerge320;
if (AESL_DEBUG_TRACE)
printf("\nstoremerge320 = 0x%X\n", llvm_cbe_storemerge320);
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__64:
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_dec_MIMD_sw(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 1) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_109_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%storemerge616, i32* %%51, align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_146_count);
  *llvm_cbe_tmp__42 = llvm_cbe_storemerge616;
if (AESL_DEBUG_TRACE)
printf("\nstoremerge616 = 0x%X\n", llvm_cbe_storemerge616);
if (AESL_DEBUG_TRACE)

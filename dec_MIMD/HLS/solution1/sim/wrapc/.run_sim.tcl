...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dec_MIMD.autotvin.dat"
	set constFileTvOut       "dec_MIMD.autotvout.dat"
	set constFileHdlTvIn     "dec_MIMD.autohdltvin.dat"
	set constFileHdlTvOut    "dec_MIMD.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

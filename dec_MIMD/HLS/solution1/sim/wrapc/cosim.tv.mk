...
$(ObjDir)/test_core.c_pre.c.tb.o : test_core.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) test_core.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/core.c_pre.c.tb.o : core.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) core.c_pre.c.tb.c" $(AVE_DIR_DLOG)

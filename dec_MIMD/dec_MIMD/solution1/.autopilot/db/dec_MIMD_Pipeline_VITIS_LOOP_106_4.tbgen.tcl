set moduleName dec_MIMD_Pipeline_VITIS_LOOP_106_4
set isTopModule 0
...
set C_modelName {dec_MIMD_Pipeline_VITIS_LOOP_106_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 32 regular {axi_master 1}  }
	{ data_result int 32 regular {array 10 { 1 3 } 1 1 }  }
	{ c int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "data_result", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ data_result_address0 sc_out sc_lv 4 signal 1 } 
	{ data_result_ce0 sc_out sc_logic 1 signal 1 } 
	{ data_result_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_result_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "data_result", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	data_result { ap_memory {  { data_result_address0 mem_address 1 4 }  { data_result_ce0 mem_ce 1 1 }  { data_result_q0 mem_dout 0 32 } } }

set moduleName dec_MIMD_Pipeline_VITIS_LOOP_35_1
set isTopModule 0
...
set C_modelName {dec_MIMD_Pipeline_VITIS_LOOP_35_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem3 int 32 regular {axi_master 0}  }
	{ gmem1 int 32 regular {axi_master 0}  }
	{ gmem0 int 32 regular {axi_master 0}  }
	{ group_assign int 32 regular {pointer 0 volatile }  }
	{ a int 64 regular  }
	{ data_a int 32 regular {array 50 { 0 3 } 0 1 }  }
	{ b int 64 regular  }
	{ data_b int 32 regular {array 50 { 0 3 } 0 1 }  }
	{ op int 64 regular  }
	{ ALU_operation int 32 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "op","offset": { "type": "dynamic","port_name": "op","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "group_assign", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "data_a", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "b", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "data_b", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "op", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "ALU_operation", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ group_assign sc_in sc_lv 32 signal 3 } 
	{ a sc_in sc_lv 64 signal 4 } 
	{ data_a_address0 sc_out sc_lv 6 signal 5 } 
	{ data_a_ce0 sc_out sc_logic 1 signal 5 } 
	{ data_a_we0 sc_out sc_logic 1 signal 5 } 
	{ data_a_d0 sc_out sc_lv 32 signal 5 } 
	...
	{ op sc_in sc_lv 64 signal 8 } 
	{ ALU_operation_address0 sc_out sc_lv 4 signal 9 } 
	{ ALU_operation_ce0 sc_out sc_logic 1 signal 9 } 
	{ ALU_operation_we0 sc_out sc_logic 1 signal 9 } 
	{ ALU_operation_d0 sc_out sc_lv 32 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "group_assign", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "group_assign", "role": "default" }} , 
 	...
 	{ "name": "ALU_operation_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "ALU_operation", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	group_assign { ap_none {  { group_assign in_data 0 32 } } }
	...
	ALU_operation { ap_memory {  { ALU_operation_address0 mem_address 1 4 }  { ALU_operation_ce0 mem_ce 1 1 }  { ALU_operation_we0 mem_we 1 1 }  { ALU_operation_d0 mem_din 1 32 } } }
}

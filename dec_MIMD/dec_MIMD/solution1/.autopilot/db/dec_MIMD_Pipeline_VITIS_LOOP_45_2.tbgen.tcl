set moduleName dec_MIMD_Pipeline_VITIS_LOOP_45_2
set isTopModule 0
...
set C_modelName {dec_MIMD_Pipeline_VITIS_LOOP_45_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_a int 32 regular {array 50 { 1 3 } 1 1 }  }
	{ ALU_operation int 32 regular {array 10 { 1 3 } 1 1 }  }
	{ data_result int 32 regular {array 10 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "data_a", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "ALU_operation", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ALU_operation_address0 sc_out sc_lv 4 signal 1 } 
	{ ALU_operation_ce0 sc_out sc_logic 1 signal 1 } 
	{ ALU_operation_q0 sc_in sc_lv 32 signal 1 } 
	{ data_result_address0 sc_out sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_result_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "data_result", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	ALU_operation { ap_memory {  { ALU_operation_address0 mem_address 1 4 }  { ALU_operation_ce0 mem_ce 1 1 }  { ALU_operation_q0 in_data 0 32 } } }
	data_result { ap_memory {  { data_result_address0 mem_address 1 4 }  { data_result_ce0 mem_ce 1 1 }  { data_result_we0 mem_we 1 1 }  { data_result_d0 mem_din 1 32 } } }

...
localparam
    ...
    ADDR_C_DATA_1       = 7'h2c,
    ADDR_C_CTRL         = 7'h30,
    ADDR_OP_DATA_0      = 7'h34,
    ADDR_OP_DATA_1      = 7'h38,
    ADDR_OP_CTRL        = 7'h3c,
    ADDR_GROUP_R_DATA_0 = 7'h40,
    ADDR_GROUP_R_CTRL   = 7'h44,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_GROUP_R_DATA_0: begin
                    rdata <= int_group_r[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_GROUP_R_DATA_0)
            int_group_r[31:0] <= (WDATA[31:0] & wmask) | (int_group_r[31:0] & ~wmask);
    end
end

...
`define AUTOTB_DUT      dec_MIMD
`define AUTOTB_DUT_INST AESL_inst_dec_MIMD
`define AUTOTB_TOP      apatb_dec_MIMD_top
`define AUTOTB_LAT_RESULT_FILE "dec_MIMD.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "dec_MIMD.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_dec_MIMD_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem3_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvin_gmem3.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvin_c.dat"
`define AUTOTB_TVIN_op_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvin_op.dat"
`define AUTOTB_TVIN_group_r_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvin_group_r.dat"
`define AUTOTB_TVOUT_gmem2  "../tv/cdatafile/c.dec_MIMD.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.dec_MIMD.autotvout_gmem2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 185;
parameter LENGTH_a = 1;
parameter LENGTH_b = 1;
parameter LENGTH_c = 1;
parameter LENGTH_gmem0 = 50;
parameter LENGTH_gmem1 = 50;
parameter LENGTH_gmem2 = 50;
parameter LENGTH_gmem3 = 50;
parameter LENGTH_group_r = 1;
...
reg end_group_r;
reg [31:0] size_group_r;
reg [31:0] size_group_r_backup;
reg end_gmem2;
reg [31:0] size_gmem2;

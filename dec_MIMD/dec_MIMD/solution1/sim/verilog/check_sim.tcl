...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.dec_MIMD.autotvin_gmem0.dat"
         "c.dec_MIMD.autotvin_gmem1.dat"
         "c.dec_MIMD.autotvin_gmem3.dat"
         "c.dec_MIMD.autotvin_a.dat"
         "c.dec_MIMD.autotvin_b.dat"
         "c.dec_MIMD.autotvin_c.dat"
         "c.dec_MIMD.autotvin_op.dat"
         "c.dec_MIMD.autotvin_group_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.dec_MIMD.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

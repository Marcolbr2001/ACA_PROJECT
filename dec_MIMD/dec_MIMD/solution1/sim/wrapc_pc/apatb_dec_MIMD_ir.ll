; ModuleID = 'C:/Users/lotto/Desktop/Alveare/M_AXI_ALU/M_AXI_ALU/dec_MIMD/dec_MIMD/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_dec_MIMD_ir(i32* noalias nonnull "maxi" %a, i32* noalias nonnull "maxi" %b, i32* noalias nonnull "maxi" %c, i32* noalias nonnull "maxi" %op, i32 %group) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_dec_MIMD_hw([50 x i32]* %a_copy, [50 x i32]* %b_copy, [50 x i32]* %c_copy, [50 x i32]* %op_copy, i32 %group)
...
declare void @apatb_dec_MIMD_hw([50 x i32]*, [50 x i32]*, [50 x i32]*, [50 x i32]*, i32)
...
define void @dec_MIMD_hw_stub_wrapper([50 x i32]*, [50 x i32]*, [50 x i32]*, [50 x i32]*, i32) #5 {
entry:

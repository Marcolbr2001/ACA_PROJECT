...
void XDec_mimd_Set_group_r(XDec_mimd *InstancePtr, u32 Data) {
    ...
    XDec_mimd_WriteReg(InstancePtr->Control_BaseAddress, XDEC_MIMD_CONTROL_ADDR_GROUP_R_DATA, Data);
}
...
u32 XDec_mimd_Get_group_r(XDec_mimd *InstancePtr) {
    ...
    Data = XDec_mimd_ReadReg(InstancePtr->Control_BaseAddress, XDEC_MIMD_CONTROL_ADDR_GROUP_R_DATA);
    return Data;
}

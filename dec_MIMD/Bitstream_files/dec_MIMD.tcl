...
#
# dec_MIMD.tcl: Tcl script for re-creating project 'dec_MIMD'
#
# Generated by Vivado on Wed Apr 24 23:59:01 +0200 2024
...
#
# 1. This project restoration tcl script (dec_MIMD.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/lotto/Desktop/Alveare/M_AXI_ALU/M_AXI_ALU/dec_MIMD/Vivado/dec_MIMD.srcs/sources_1/bd/design_1/design_1.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../Vivado/dec_MIMD.srcs/sources_1/bd/design_1/design_1.bd"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../Vivado/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../Vivado/dec_MIMD.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {

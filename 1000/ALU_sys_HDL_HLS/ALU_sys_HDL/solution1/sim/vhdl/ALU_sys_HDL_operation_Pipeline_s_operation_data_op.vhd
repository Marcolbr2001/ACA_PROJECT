...
begin
    ...
    add_ln94_fu_74_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv10_1));
    ...
    icmp_ln94_fu_68_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv10_3E8) else "0";

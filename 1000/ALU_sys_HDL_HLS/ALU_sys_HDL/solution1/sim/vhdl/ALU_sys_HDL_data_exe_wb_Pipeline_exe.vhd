...
attribute shreg_extract : string;
    ...
    signal i_reg_137 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal i_8_fu_46 : STD_LOGIC_VECTOR (9 downto 0) := "0000000000";
    signal add_ln127_fu_101_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    mul_32s_32s_32_2_1_U42 : component ALU_sys_HDL_mul_32s_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    sdiv_32s_32s_32_36_1_U43 : component ALU_sys_HDL_sdiv_32s_32s_32_36_1
    generic map (
        ID => 1,
        NUM_STAGE => 36,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln127_fu_95_p2 = ap_const_lv1_0))) then 
                    i_8_fu_46 <= add_ln127_fu_101_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_8_fu_46 <= ap_const_lv10_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    ALU_operation_MEM_address0 <= zext_ln127_fu_112_p1(10 - 1 downto 0);
    ...
    add_ln127_fu_101_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv10_1));
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_8_fu_46, ap_loop_init)
    begin
    ...
    icmp_ln127_fu_95_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv10_3E8) else "0";

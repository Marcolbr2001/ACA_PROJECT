...
begin
    ...
    add_ln81_fu_105_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_5) + unsigned(ap_const_lv10_1));
    ...
    icmp_ln81_fu_99_p2 <= "1" when (ap_sig_allocacmp_i_5 = ap_const_lv10_3E8) else "0";

...
attribute shreg_extract : string;
    ...
    signal ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal grp_op_data_exe_wb_fu_112_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal grp_data_exe_wb_fu_142_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal grp_operation_fu_166_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal grp_reset_fu_178_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    component ALU_sys_HDL_fifo_w32_d1000_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ...
    ALU_operation_fifo_U : component ALU_sys_HDL_fifo_w32_d1000_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    data_a_fifo_U : component ALU_sys_HDL_fifo_w32_d1000_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    data_b_fifo_U : component ALU_sys_HDL_fifo_w32_d1000_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    data_result_fifo_U : component ALU_sys_HDL_fifo_w32_d1000_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,

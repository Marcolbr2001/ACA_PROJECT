...
set portList { 
	...
	{ ALU_operation_MEM_address0 sc_out sc_lv 10 signal 0 } 
...
set Spec2ImplPortList { 
	ALU_operation_MEM { ap_memory {  { ALU_operation_MEM_address0 mem_address 1 10 }  { ALU_operation_MEM_ce0 mem_ce 1 1 }  { ALU_operation_MEM_q0 in_data 0 32 } } }

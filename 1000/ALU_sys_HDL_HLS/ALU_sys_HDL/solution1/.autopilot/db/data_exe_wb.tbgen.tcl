...
set C_modelArgList {
	...
	{ c int 64 regular  }
	{ ALU_operation_MEM int 32 regular {array 1000 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ ALU_operation_MEM_address0 sc_out sc_lv 10 signal 6 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "5", "9"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "4080", "EstimateLatencyMax" : "4080",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4080", "Max" : "4080"}
	, {"Name" : "Interval", "Min" : "4080", "Max" : "4080"}
]}
...
set Spec2ImplPortList { 
	...
	ALU_operation_MEM { ap_memory {  { ALU_operation_MEM_address0 mem_address 1 10 }  { ALU_operation_MEM_ce0 mem_ce 1 1 }  { ALU_operation_MEM_q0 mem_dout 0 32 } } }

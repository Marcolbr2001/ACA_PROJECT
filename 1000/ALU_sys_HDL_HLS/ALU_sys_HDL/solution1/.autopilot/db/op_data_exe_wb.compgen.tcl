...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ALU_operation_MEM_address0 { O 10 vector } ALU_operation_MEM_ce0 { O 1 bit } ALU_operation_MEM_we0 { O 1 bit } ALU_operation_MEM_d0 { O 32 vector } ALU_operation_MEM_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_data_a \
    op interface \
    ports { data_a_dout { I 32 vector } data_a_empty_n { I 1 bit } data_a_read { O 1 bit } data_a_din { O 32 vector } data_a_full_n { I 1 bit } data_a_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_data_b \
    op interface \
    ports { data_b_dout { I 32 vector } data_b_empty_n { I 1 bit } data_b_read { O 1 bit } data_b_din { O 32 vector } data_b_full_n { I 1 bit } data_b_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { data_result_dout { I 32 vector } data_result_empty_n { I 1 bit } data_result_read { O 1 bit } data_result_din { O 32 vector } data_result_full_n { I 1 bit } data_result_write { O 1 bit } } \
} "
}

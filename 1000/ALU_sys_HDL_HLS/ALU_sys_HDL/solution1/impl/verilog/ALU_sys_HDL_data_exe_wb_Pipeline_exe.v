...
module ALU_sys_HDL_data_exe_wb_Pipeline_exe (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln127_fu_101_p2 = (ap_sig_allocacmp_i + 10'd1);
...
assign icmp_ln127_fu_95_p2 = ((ap_sig_allocacmp_i == 10'd1000) ? 1'b1 : 1'b0);
...
endmodule //ALU_sys_HDL_data_exe_wb_Pipeline_exe

...
module ALU_sys_HDL_operation_Pipeline_s_operation_data_op (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln94_fu_74_p2 = (ap_sig_allocacmp_i + 10'd1);
...
assign icmp_ln94_fu_68_p2 = ((ap_sig_allocacmp_i == 10'd1000) ? 1'b1 : 1'b0);

assign zext_ln94_fu_85_p1 = i_reg_96;

endmodule //ALU_sys_HDL_operation_Pipeline_s_operation_data_op

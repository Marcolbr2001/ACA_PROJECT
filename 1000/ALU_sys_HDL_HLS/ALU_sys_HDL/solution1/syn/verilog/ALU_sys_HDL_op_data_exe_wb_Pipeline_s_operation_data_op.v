...
module ALU_sys_HDL_op_data_exe_wb_Pipeline_s_operation_data_op (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln94_fu_85_p1;
reg   [9:0] i_fu_36;
wire   [9:0] add_ln94_fu_74_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln94_fu_68_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln94_fu_68_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign ALU_operation_MEM_address0 = zext_ln94_fu_85_p1;

assign ALU_operation_MEM_d0 = ALU_operation_dout;

assign add_ln94_fu_74_p2 = (ap_sig_allocacmp_i_4 + 10'd1);
...
assign icmp_ln94_fu_68_p2 = ((ap_sig_allocacmp_i_4 == 10'd1000) ? 1'b1 : 1'b0);

assign zext_ln94_fu_85_p1 = i_4_reg_96;

endmodule //ALU_sys_HDL_op_data_exe_wb_Pipeline_s_operation_data_op

...
// ==============================================================
`timescale 1ns/1ps
module ALU_sys_HDL_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_OP_CTRL      = 7'h3c,
    ADDR_SELEC_DATA_0 = 7'h40,
    ADDR_SELEC_CTRL   = 7'h44,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_SELEC_DATA_0: begin
                    rdata <= int_selec[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SELEC_DATA_0)
            int_selec[31:0] <= (WDATA[31:0] & wmask) | (int_selec[31:0] & ~wmask);
    end
end

...
entity ALU_sys_HDL_op_data_exe_wb_Pipeline_write_back is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ALU_sys_HDL_op_data_exe_wb_Pipeline_write_back is 
...
begin
    ...
    add_ln166_fu_112_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv10_1));
    ...
    icmp_ln166_fu_106_p2 <= "1" when (ap_sig_allocacmp_i_3 = ap_const_lv10_3E8) else "0";
    ...
    begin
        ...
        sext_ln169_fu_146_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln3_fu_136_p4),64));

    shl_ln3_fu_118_p3 <= (ap_sig_allocacmp_i_3 & ap_const_lv2_0);
    trunc_ln3_fu_136_p4 <= add_ln169_fu_130_p2(63 downto 2);
    zext_ln169_fu_126_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln3_fu_118_p3),64));
end behav;

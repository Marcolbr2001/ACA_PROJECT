...
entity alv_MIMD_op_data_exe_wb_Pipeline_l_data_b is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of alv_MIMD_op_data_exe_wb_Pipeline_l_data_b is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln54_fu_99_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal sext_ln58_fu_139_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_4_fu_62 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal add_ln54_fu_105_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal shl_ln2_fu_111_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln58_fu_119_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln58_fu_123_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln2_fu_129_p4 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
    ...
    i_4_fu_62_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln54_fu_99_p2 = ap_const_lv1_0))) then 
                    i_4_fu_62 <= add_ln54_fu_105_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_4_fu_62 <= ap_const_lv6_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                gmem1_addr_reg_165 <= sext_ln58_fu_139_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln54_fu_105_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv6_1));
    add_ln58_fu_123_p2 <= std_logic_vector(unsigned(zext_ln58_fu_119_p1) + unsigned(b));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln54_fu_99_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln54_fu_99_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_4_fu_62, ap_loop_init)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_i <= ap_const_lv6_0;
        else 
            ap_sig_allocacmp_i <= i_4_fu_62;
        end if; 
    end process;
    ...
    icmp_ln54_fu_99_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv6_32) else "0";
    ...
    m_axi_gmem1_WVALID <= ap_const_logic_0;
        sext_ln58_fu_139_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln2_fu_129_p4),64));

    shl_ln2_fu_111_p3 <= (ap_sig_allocacmp_i & ap_const_lv2_0);
    trunc_ln2_fu_129_p4 <= add_ln58_fu_123_p2(63 downto 2);
    zext_ln58_fu_119_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln2_fu_111_p3),64));
end behav;

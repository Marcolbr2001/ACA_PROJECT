...
if {[file isfile alv_MIMD.autotvin.dat]} {
	file delete -force alv_MIMD.autotvin.dat
}

if {[file isfile alv_MIMD.autotvout.dat]} {
	file delete -force alv_MIMD.autotvout.dat
}

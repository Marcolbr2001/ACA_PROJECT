...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "alv_MIMD.autotvin.dat"
	set constFileTvOut       "alv_MIMD.autotvout.dat"
	set constFileHdlTvIn     "alv_MIMD.autohdltvin.dat"
	set constFileHdlTvOut    "alv_MIMD.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

...
entity alv_MIMD_alv_MIMD_Pipeline_output is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of alv_MIMD_alv_MIMD_Pipeline_output is 
...
begin
    ...
    add_ln138_fu_114_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_5) + unsigned(ap_const_lv6_1));
    ...
    icmp_ln138_fu_108_p2 <= "1" when (ap_sig_allocacmp_i_5 = ap_const_lv6_32) else "0";
    ...
    begin
        ...
        sext_ln141_fu_148_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln6_fu_138_p4),64));

    shl_ln5_fu_120_p3 <= (ap_sig_allocacmp_i_5 & ap_const_lv2_0);
    trunc_ln6_fu_138_p4 <= add_ln141_fu_132_p2(63 downto 2);
    zext_ln141_fu_128_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln5_fu_120_p3),64));
end behav;

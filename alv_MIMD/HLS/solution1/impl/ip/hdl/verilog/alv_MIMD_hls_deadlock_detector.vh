...
reg [15:0] trans_in_cnt_0;// for process grp_lod_exe_wb_fu_114.load_op_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (grp_lod_exe_wb_fu_114.load_op_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process grp_lod_exe_wb_fu_114.load_op_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (grp_lod_exe_wb_fu_114.load_op_U0.ap_done == 1'b1 && grp_lod_exe_wb_fu_114.load_op_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_1;// for process grp_lod_exe_wb_fu_114.entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_1 <= 16'h0;
    end
    else if (grp_lod_exe_wb_fu_114.entry_proc_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_1;// for process grp_lod_exe_wb_fu_114.entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_1 <= 16'h0;
    end
    else if (grp_lod_exe_wb_fu_114.entry_proc_U0.ap_done == 1'b1 && grp_lod_exe_wb_fu_114.entry_proc_U0.ap_continue == 1'b1) begin
    ...
    // Process: grp_lod_exe_wb_fu_114.entry_proc_U0
    alv_MIMD_hls_deadlock_detect_unit #(6, 0, 4, 4) alv_MIMD_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.entry_proc_U0.c_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.start_for_write_back_U0_U.if_full_n & grp_lod_exe_wb_fu_114.entry_proc_U0.ap_start & ~grp_lod_exe_wb_fu_114.entry_proc_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~grp_lod_exe_wb_fu_114.start_for_write_back_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[1] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_entry_proc_U0_ap_ready & grp_lod_exe_wb_fu_114.entry_proc_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_op_U0_ap_ready);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_entry_proc_U0_ap_ready & grp_lod_exe_wb_fu_114.entry_proc_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_data_a_U0_ap_ready);
    ...
    assign proc_0_input_sync_blk[3] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_entry_proc_U0_ap_ready & grp_lod_exe_wb_fu_114.entry_proc_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_data_b_U0_ap_ready);
    ...
    // Process: grp_lod_exe_wb_fu_114.load_op_U0
    alv_MIMD_hls_deadlock_detect_unit #(6, 1, 4, 4) alv_MIMD_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.load_op_U0.ALU_operation_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.start_for_execute_U0_U.if_full_n & grp_lod_exe_wb_fu_114.load_op_U0.ap_start & ~grp_lod_exe_wb_fu_114.load_op_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~grp_lod_exe_wb_fu_114.start_for_execute_U0_U.if_read);
    ...
    assign proc_1_input_sync_blk[1] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_op_U0_ap_ready & grp_lod_exe_wb_fu_114.load_op_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_1_input_sync_blk[2] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_op_U0_ap_ready & grp_lod_exe_wb_fu_114.load_op_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_data_a_U0_ap_ready);
    ...
    assign proc_1_input_sync_blk[3] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_op_U0_ap_ready & grp_lod_exe_wb_fu_114.load_op_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_data_b_U0_ap_ready);
    ...
    // Process: grp_lod_exe_wb_fu_114.load_data_a_U0
    alv_MIMD_hls_deadlock_detect_unit #(6, 2, 4, 4) alv_MIMD_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.load_data_a_U0.data_a_blk_n);
    ...
    assign proc_2_input_sync_blk[1] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_data_a_U0_ap_ready & grp_lod_exe_wb_fu_114.load_data_a_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_2_input_sync_blk[2] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_data_a_U0_ap_ready & grp_lod_exe_wb_fu_114.load_data_a_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_op_U0_ap_ready);
    ...
    assign proc_2_input_sync_blk[3] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_data_a_U0_ap_ready & grp_lod_exe_wb_fu_114.load_data_a_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_data_b_U0_ap_ready);
    ...
    // Process: grp_lod_exe_wb_fu_114.load_data_b_U0
    alv_MIMD_hls_deadlock_detect_unit #(6, 3, 4, 4) alv_MIMD_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.load_data_b_U0.data_b_blk_n);
    ...
    assign proc_3_input_sync_blk[1] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_data_b_U0_ap_ready & grp_lod_exe_wb_fu_114.load_data_b_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_entry_proc_U0_ap_ready);
    ...
    assign proc_3_input_sync_blk[2] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_data_b_U0_ap_ready & grp_lod_exe_wb_fu_114.load_data_b_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_op_U0_ap_ready);
    ...
    assign proc_3_input_sync_blk[3] = 1'b0 | (grp_lod_exe_wb_fu_114.ap_sync_load_data_b_U0_ap_ready & grp_lod_exe_wb_fu_114.load_data_b_U0.ap_idle & ~grp_lod_exe_wb_fu_114.ap_sync_load_data_a_U0_ap_ready);
    ...
    // Process: grp_lod_exe_wb_fu_114.execute_U0
    alv_MIMD_hls_deadlock_detect_unit #(6, 4, 4, 4) alv_MIMD_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.execute_U0.ALU_operation_blk_n);
    assign proc_4_data_PIPO_blk[0] = 1'b0;
    assign proc_4_start_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.start_for_execute_U0_U.if_empty_n & grp_lod_exe_wb_fu_114.execute_U0.ap_idle & ~grp_lod_exe_wb_fu_114.start_for_execute_U0_U.if_write);
    assign proc_4_TLF_FIFO_blk[0] = 1'b0;
    assign proc_4_input_sync_blk[0] = 1'b0;
    assign proc_4_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_4[0] = dl_detect_out ? proc_dep_vld_vec_4_reg[0] : (proc_4_data_FIFO_blk[0] | proc_4_data_PIPO_blk[0] | proc_4_start_FIFO_blk[0] | proc_4_TLF_FIFO_blk[0] | proc_4_input_sync_blk[0] | proc_4_output_sync_blk[0]);
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~grp_lod_exe_wb_fu_114.execute_U0.data_a_blk_n);
    ...
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~grp_lod_exe_wb_fu_114.execute_U0.data_result_blk_n);
    ...
    assign proc_4_data_FIFO_blk[3] = 1'b0 | (~grp_lod_exe_wb_fu_114.execute_U0.data_b_blk_n);
    ...
    // Process: grp_lod_exe_wb_fu_114.write_back_U0
    alv_MIMD_hls_deadlock_detect_unit #(6, 5, 2, 2) alv_MIMD_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.write_back_U0.c_blk_n);
    assign proc_5_data_PIPO_blk[0] = 1'b0;
    assign proc_5_start_FIFO_blk[0] = 1'b0 | (~grp_lod_exe_wb_fu_114.start_for_write_back_U0_U.if_empty_n & grp_lod_exe_wb_fu_114.write_back_U0.ap_idle & ~grp_lod_exe_wb_fu_114.start_for_write_back_U0_U.if_write);
    assign proc_5_TLF_FIFO_blk[0] = 1'b0;
    assign proc_5_input_sync_blk[0] = 1'b0;
    assign proc_5_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_5[0] = dl_detect_out ? proc_dep_vld_vec_5_reg[0] : (proc_5_data_FIFO_blk[0] | proc_5_data_PIPO_blk[0] | proc_5_start_FIFO_blk[0] | proc_5_TLF_FIFO_blk[0] | proc_5_input_sync_blk[0] | proc_5_output_sync_blk[0]);
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~grp_lod_exe_wb_fu_114.write_back_U0.grp_write_back_Pipeline_write_back_fu_46.data_result_blk_n);
...
`include "alv_MIMD_hls_deadlock_report_unit.vh"

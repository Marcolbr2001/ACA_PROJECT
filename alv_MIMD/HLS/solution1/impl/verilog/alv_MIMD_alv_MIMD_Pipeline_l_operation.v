...
module alv_MIMD_alv_MIMD_Pipeline_l_operation (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] gmem3_addr_reg_167;
reg   [31:0] tmp_op_reg_173;
wire  signed [63:0] sext_ln46_fu_141_p1;
reg   [5:0] i_2_fu_64;
wire   [5:0] add_ln42_fu_107_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_i;
reg    ap_block_pp0_stage0_01001;
wire   [7:0] shl_ln2_fu_113_p3;
wire   [63:0] zext_ln46_fu_121_p1;
wire   [63:0] add_ln46_fu_125_p2;
wire   [61:0] trunc_ln2_fu_131_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln42_fu_101_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln42_fu_101_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign ALU_operation_din = tmp_op_reg_173;

assign add_ln42_fu_107_p2 = (ap_sig_allocacmp_i + 6'd1);

assign add_ln46_fu_125_p2 = (zext_ln46_fu_121_p1 + op);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter10 == 1'b1) & (1'b1 == ap_block_state11_pp0_stage0_iter10)) | ((ap_enable_reg_pp0_iter9 == 1'b1) & (1'b1 == ap_block_state10_pp0_stage0_iter9)) | ((m_axi_gmem3_ARREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter10 == 1'b1) & (1'b1 == ap_block_state11_pp0_stage0_iter10)) | ((ap_enable_reg_pp0_iter9 == 1'b1) & (1'b1 == ap_block_state10_pp0_stage0_iter9)) | ((m_axi_gmem3_ARREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
assign icmp_ln42_fu_101_p2 = ((ap_sig_allocacmp_i == 6'd50) ? 1'b1 : 1'b0);

assign m_axi_gmem3_ARADDR = gmem3_addr_reg_167;
...
assign sext_ln46_fu_141_p1 = $signed(trunc_ln2_fu_131_p4);

assign shl_ln2_fu_113_p3 = {{ap_sig_allocacmp_i}, {2'd0}};

assign trunc_ln2_fu_131_p4 = {{add_ln46_fu_125_p2[63:2]}};

assign zext_ln46_fu_121_p1 = shl_ln2_fu_113_p3;

endmodule //alv_MIMD_alv_MIMD_Pipeline_l_operation

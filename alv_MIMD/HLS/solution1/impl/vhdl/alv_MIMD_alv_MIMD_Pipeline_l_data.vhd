...
entity alv_MIMD_alv_MIMD_Pipeline_l_data is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of alv_MIMD_alv_MIMD_Pipeline_l_data is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln23_fu_110_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem0_addr_reg_176 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_a_reg_182 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln27_fu_150_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_3_fu_66 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal add_ln23_fu_116_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal shl_ln3_fu_122_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln27_fu_130_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln27_fu_134_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln3_fu_140_p4 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln23_fu_110_p2 = ap_const_lv1_0))) then 
                    i_3_fu_66 <= add_ln23_fu_116_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_3_fu_66 <= ap_const_lv6_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                gmem0_addr_reg_176 <= sext_ln27_fu_150_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                tmp_a_reg_182 <= m_axi_gmem0_RDATA;
            end if;
        end if;
    end process;
    ...
    add_ln23_fu_116_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv6_1));
    add_ln27_fu_134_p2 <= std_logic_vector(unsigned(zext_ln27_fu_130_p1) + unsigned(a));
    ...
    ap_block_state11_pp0_stage0_iter10_assign_proc : process(data_a_full_n, data_b_full_n)
    begin
                ap_block_state11_pp0_stage0_iter10 <= ((data_b_full_n = ap_const_logic_0) or (data_a_full_n = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln23_fu_110_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln23_fu_110_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    icmp_ln23_fu_110_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv6_32) else "0";
    m_axi_gmem0_ARADDR <= gmem0_addr_reg_176;
    ...
    m_axi_gmem0_WVALID <= ap_const_logic_0;
        sext_ln27_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln3_fu_140_p4),64));

    shl_ln3_fu_122_p3 <= (ap_sig_allocacmp_i & ap_const_lv2_0);
    trunc_ln3_fu_140_p4 <= add_ln27_fu_134_p2(63 downto 2);
    zext_ln27_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln3_fu_122_p3),64));
end behav;

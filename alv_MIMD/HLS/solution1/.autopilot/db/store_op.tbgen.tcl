...
set portList { 
	...
	{ ALU_operation_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ ALU_operation_fifo_cap sc_in sc_lv 3 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "ALU_operation_MEM", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0"},
			{"Name" : "ALU_operation", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ALU_operation_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "s_operation", "PipelineType" : "UPC",
...
set Spec2ImplPortList { 
	...
	ALU_operation { ap_fifo {  { ALU_operation_dout fifo_data_in 0 32 }  { ALU_operation_num_data_valid fifo_status_num_data_valid 0 3 }  { ALU_operation_fifo_cap fifo_update 0 3 }  { ALU_operation_empty_n fifo_status 0 1 }  { ALU_operation_read fifo_port_we 1 1 } } }
}

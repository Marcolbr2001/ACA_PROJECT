...
entity alv_MIMD_start_for_execute_U0 is 
    generic (
...
architecture rtl of alv_MIMD_start_for_execute_U0 is

    component alv_MIMD_start_for_execute_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_alv_MIMD_start_for_execute_U0_ShiftReg : alv_MIMD_start_for_execute_U0_ShiftReg
    generic map (
...
entity alv_MIMD_start_for_execute_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end alv_MIMD_start_for_execute_U0_ShiftReg;

architecture rtl of alv_MIMD_start_for_execute_U0_ShiftReg is

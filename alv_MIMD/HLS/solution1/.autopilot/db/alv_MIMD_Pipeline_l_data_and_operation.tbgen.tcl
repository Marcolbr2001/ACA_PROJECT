set moduleName alv_MIMD_Pipeline_l_data_and_operation
set isTopModule 0
...
set C_modelName {alv_MIMD_Pipeline_l_data_and_operation}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem3 int 32 regular {axi_master 0}  }
	{ gmem0 int 32 regular {axi_master 0}  }
	{ a int 64 regular  }
	{ data_a int 32 regular {fifo 1 volatile }  }
	{ data_b int 32 regular {fifo 1 volatile }  }
	{ op int 64 regular  }
	{ ALU_operation int 32 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "op","offset": { "type": "dynamic","port_name": "op","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "data_a", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "data_b", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "op", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "ALU_operation", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ data_a_din sc_out sc_lv 32 signal 3 } 
	{ data_a_full_n sc_in sc_logic 1 signal 3 } 
	{ data_a_write sc_out sc_logic 1 signal 3 } 
	{ data_b_din sc_out sc_lv 32 signal 4 } 
	{ data_b_full_n sc_in sc_logic 1 signal 4 } 
	{ data_b_write sc_out sc_logic 1 signal 4 } 
	{ ALU_operation_din sc_out sc_lv 32 signal 6 } 
	{ ALU_operation_full_n sc_in sc_logic 1 signal 6 } 
	{ ALU_operation_write sc_out sc_logic 1 signal 6 } 
...
set Spec2ImplPortList { 
	...
	data_a { ap_fifo {  { data_a_din fifo_data_in 1 32 }  { data_a_full_n fifo_status 0 1 }  { data_a_write fifo_port_we 1 1 } } }
	data_b { ap_fifo {  { data_b_din fifo_data_in 1 32 }  { data_b_full_n fifo_status 0 1 }  { data_b_write fifo_port_we 1 1 } } }
	op { ap_none {  { op in_data 0 64 } } }
	ALU_operation { ap_fifo {  { ALU_operation_din fifo_data_in 1 32 }  { ALU_operation_full_n fifo_status 0 1 }  { ALU_operation_write fifo_port_we 1 1 } } }
}

...
set portList { 
	...
	{ data_a_num_data_valid sc_in sc_lv 7 signal 2 } 
	{ data_a_fifo_cap sc_in sc_lv 7 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "data_a", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	data_a { ap_fifo {  { data_a_din fifo_data_in 1 32 }  { data_a_num_data_valid fifo_status_num_data_valid 0 7 }  { data_a_fifo_cap fifo_update 0 7 }  { data_a_full_n fifo_status 0 1 }  { data_a_write fifo_port_we 1 1 } } }
}

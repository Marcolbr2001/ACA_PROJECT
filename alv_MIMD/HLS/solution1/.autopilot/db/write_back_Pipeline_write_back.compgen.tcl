...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { data_result_dout { I 32 vector } data_result_num_data_valid { I 7 vector } data_result_fifo_cap { I 7 vector } data_result_empty_n { I 1 bit } data_result_read { O 1 bit } } \
} "
}

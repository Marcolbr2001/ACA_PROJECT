set moduleName alv_MIMD_Pipeline_output1
set isTopModule 0
...
set C_modelName {alv_MIMD_Pipeline_output1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 32 regular {axi_master 1}  }
	{ data_result int 32 regular {fifo 0 volatile }  }
	{ c int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "data_result", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ data_result_dout sc_in sc_lv 32 signal 1 } 
	{ data_result_empty_n sc_in sc_logic 1 signal 1 } 
	{ data_result_read sc_out sc_logic 1 signal 1 } 
...
set Spec2ImplPortList { 
	...
	data_result { ap_fifo {  { data_result_dout fifo_data_in 0 32 }  { data_result_empty_n fifo_status 0 1 }  { data_result_read fifo_port_we 1 1 } } }

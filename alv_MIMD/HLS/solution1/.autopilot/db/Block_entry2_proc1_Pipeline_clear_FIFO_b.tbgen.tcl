set moduleName Block_entry2_proc1_Pipeline_clear_FIFO_b
set isTopModule 0
...
set C_modelName {Block_entry2_proc1_Pipeline_clear_FIFO_b}
...
set portList { 
	...
	{ data_b_dout sc_in sc_lv 32 signal 0 } 
	{ data_b_empty_n sc_in sc_logic 1 signal 0 } 
	{ data_b_read sc_out sc_logic 1 signal 0 } 
}
set NewPortList {[ 

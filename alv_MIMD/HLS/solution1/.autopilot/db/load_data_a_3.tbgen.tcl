...
set C_modelName {load_data_a.3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0}  }
	{ a int 64 regular  }
	{ data_a int 32 regular {fifo 1 volatile } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "a","offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "data_a", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ data_a_din sc_out sc_lv 32 signal 2 } 
	{ data_a_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ data_a_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ data_a_full_n sc_in sc_logic 1 signal 2 } 
	{ data_a_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_a_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "data_a", "role": "num_data_valid" }} , 
 	{ "name": "data_a_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "data_a", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "data_a", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	data_a { ap_fifo {  { data_a_din fifo_data_in 1 32 }  { data_a_num_data_valid fifo_status_num_data_valid 0 3 }  { data_a_fifo_cap fifo_update 0 3 }  { data_a_full_n fifo_status 0 1 }  { data_a_write fifo_port_we 1 1 } } }
}

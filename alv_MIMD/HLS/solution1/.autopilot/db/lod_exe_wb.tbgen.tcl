...
set portList { 
	...
	{ m_axi_gmem1_WDATA sc_out sc_lv 32 signal 4 } 
	{ m_axi_gmem1_WSTRB sc_out sc_lv 4 signal 4 } 
	...
	{ m_axi_gmem1_RDATA sc_in sc_lv 32 signal 4 } 
	...
	{ c_ap_vld sc_in sc_logic 1 invld 7 } 
	{ ap_start sc_in sc_logic 1 start -1 } 
	{ op_ap_vld sc_in sc_logic 1 invld 1 } 
...
set NewPortList {[ 
	{ "name": "m_axi_gmem3_AWVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gmem3", "role": "AWVALID" }} , 
 	...
 	{ "name": "op_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "op", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "6", "8", "12", "15", "16", "17", "18", "19", "20", "21"],
		"CDFG" : "lod_exe_wb",
		"Protocol" : "ap_ctrl_hs",
		...
		"InputProcess" : [
			...
			{"ID" : "2", "Name" : "load_op_U0"},
			{"ID" : "4", "Name" : "load_data_a_U0"},
			{"ID" : "6", "Name" : "load_data_b_U0"}],
		"OutputProcess" : [
			{"ID" : "12", "Name" : "write_back_U0"}],
		"Port" : [
			{"Name" : "gmem3", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "load_op_U0", "Port" : "gmem3"}]},
			{"Name" : "op", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "load_data_a_U0", "Port" : "gmem0"}]},
			{"Name" : "a", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "load_data_b_U0", "Port" : "gmem1"}]},
			{"Name" : "b", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "12", "SubInstance" : "write_back_U0", "Port" : "gmem2"}]},
			{"Name" : "c", "Type" : "None", "Direction" : "I"},
			{"Name" : "ALU_operation", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "execute_U0", "Port" : "ALU_operation"},
					{"ID" : "2", "SubInstance" : "load_op_U0", "Port" : "ALU_operation"}]},
			{"Name" : "data_a", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "execute_U0", "Port" : "data_a"},
					{"ID" : "4", "SubInstance" : "load_data_a_U0", "Port" : "data_a"}]},
			{"Name" : "data_b", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "execute_U0", "Port" : "data_b"},
					{"ID" : "6", "SubInstance" : "load_data_b_U0", "Port" : "data_b"}]},
			{"Name" : "data_result", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "execute_U0", "Port" : "data_result"},
					{"ID" : "12", "SubInstance" : "write_back_U0", "Port" : "data_result"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.entry_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "c", "Type" : "None", "Direction" : "I"},
			{"Name" : "c_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["12"], "DependentChan" : "15", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "c_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.load_op_U0", "Parent" : "0", "Child" : ["3"],
		"CDFG" : "load_op",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "op", "Type" : "None", "Direction" : "I"},
			{"Name" : "ALU_operation", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["8"], "DependentChan" : "16", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.load_op_U0.flow_control_loop_pipe_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.load_data_a_U0", "Parent" : "0", "Child" : ["5"],
		"CDFG" : "load_data_a",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "a", "Type" : "None", "Direction" : "I"},
			{"Name" : "data_a", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["8"], "DependentChan" : "17", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "data_a_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "l_data_a", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter10", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter10", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "1"}}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.load_data_a_U0.flow_control_loop_pipe_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.load_data_b_U0", "Parent" : "0", "Child" : ["7"],
		"CDFG" : "load_data_b",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "b", "Type" : "None", "Direction" : "I"},
			{"Name" : "data_b", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["8"], "DependentChan" : "18", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "data_b_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "l_data_b", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter10", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter10", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "1"}}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.load_data_b_U0.flow_control_loop_pipe_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.execute_U0", "Parent" : "0", "Child" : ["9", "10", "11"],
		"CDFG" : "execute",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "ALU_operation", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "16", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ALU_operation_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "data_a", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "17", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "data_a_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "data_result", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["12"], "DependentChan" : "19", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "data_result_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "data_b", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["6"], "DependentChan" : "18", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "data_b_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
	...
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.execute_U0.mul_32s_32s_32_2_1_U12", "Parent" : "8"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.execute_U0.sdiv_32ns_32ns_32_36_1_U13", "Parent" : "8"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.execute_U0.flow_control_loop_pipe_U", "Parent" : "8"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.write_back_U0", "Parent" : "0", "Child" : ["13"],
		"CDFG" : "write_back",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "grp_write_back_Pipeline_write_back_fu_46", "Port" : "gmem2", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "c", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "15", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "data_result", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "19", "DependentChanDepth" : "50", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "grp_write_back_Pipeline_write_back_fu_46", "Port" : "data_result", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}]},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.write_back_U0.grp_write_back_Pipeline_write_back_fu_46", "Parent" : "12", "Child" : ["14"],
	...
	{"ID" : "14", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.write_back_U0.grp_write_back_Pipeline_write_back_fu_46.flow_control_loop_pipe_sequential_init_U", "Parent" : "13"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.c_c_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ALU_operation_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_a_U", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_b_U", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_result_U", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_write_back_U0_U", "Parent" : "0"},
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_execute_U0_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	op { ap_none {  { op in_data 0 64 }  { op_ap_vld in_vld 0 1 } } }

...
input  [2:0] data_a_num_data_valid;
input  [2:0] data_a_fifo_cap;
input   data_a_full_n;
output   data_a_write;
input  [63:0] a;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_210)) begin
        if ((icmp_ln43_fu_99_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln43_fu_99_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln43_fu_105_p2 = (ap_sig_allocacmp_i_7 + 6'd1);
...
assign icmp_ln43_fu_99_p2 = ((ap_sig_allocacmp_i_7 == 6'd50) ? 1'b1 : 1'b0);

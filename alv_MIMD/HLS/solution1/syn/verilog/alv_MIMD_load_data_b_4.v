...
input  [2:0] data_b_num_data_valid;
input  [2:0] data_b_fifo_cap;
input   data_b_full_n;
output   data_b_write;
input  [63:0] b;
...
wire  signed [63:0] sext_ln59_fu_139_p1;
reg   [5:0] i_fu_62;
wire   [5:0] add_ln55_fu_105_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_i_5;
reg    ap_block_pp0_stage0_01001;
wire   [7:0] shl_ln_fu_111_p3;
wire   [63:0] zext_ln59_fu_119_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_210)) begin
        if ((icmp_ln55_fu_99_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln55_fu_99_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln55_fu_105_p2 = (ap_sig_allocacmp_i_5 + 6'd1);

assign add_ln59_fu_123_p2 = (zext_ln59_fu_119_p1 + b);
...
assign icmp_ln55_fu_99_p2 = ((ap_sig_allocacmp_i_5 == 6'd50) ? 1'b1 : 1'b0);
...
assign sext_ln59_fu_139_p1 = $signed(trunc_ln_fu_129_p4);

assign shl_ln_fu_111_p3 = {{ap_sig_allocacmp_i_5}, {2'd0}};

assign trunc_ln_fu_129_p4 = {{add_ln59_fu_123_p2[63:2]}};

assign zext_ln59_fu_119_p1 = shl_ln_fu_111_p3;

endmodule //alv_MIMD_load_data_b_4

...
module alv_MIMD_alv_MIMD_Pipeline_reset (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] gmem2_addr_reg_187;
wire  signed [63:0] sext_ln14_fu_161_p1;
reg    ap_block_pp0_stage0_01001;
reg   [5:0] i_fu_70;
wire   [5:0] add_ln12_fu_127_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln12_fu_121_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln12_fu_121_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln12_fu_127_p2 = (ap_sig_allocacmp_i_3 + 6'd1);

assign add_ln14_fu_145_p2 = (zext_ln14_fu_141_p1 + c);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_block_state8_pp0_stage0_iter7)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state3_pp0_stage0_iter2)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((m_axi_gmem2_AWREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_block_state8_pp0_stage0_iter7)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((m_axi_gmem2_WREADY == 1'b0) | (1'b1 == ap_block_state3_pp0_stage0_iter2))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((m_axi_gmem2_AWREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_block_state8_pp0_stage0_iter7)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((m_axi_gmem2_WREADY == 1'b0) | (1'b1 == ap_block_state3_pp0_stage0_iter2))));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((data_b_full_n == 1'b0) | (data_a_full_n == 1'b0));
end
...
assign data_a_din = 32'd0;

assign data_b_din = 32'd0;

assign icmp_ln12_fu_121_p2 = ((ap_sig_allocacmp_i_3 == 6'd50) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_AWADDR = gmem2_addr_reg_187;
...
assign sext_ln14_fu_161_p1 = $signed(trunc_ln_fu_151_p4);

assign shl_ln_fu_133_p3 = {{ap_sig_allocacmp_i_3}, {2'd0}};

assign trunc_ln_fu_151_p4 = {{add_ln14_fu_145_p2[63:2]}};

assign zext_ln14_fu_141_p1 = shl_ln_fu_133_p3;

endmodule //alv_MIMD_alv_MIMD_Pipeline_reset

...
architecture behav of alv_MIMD_store_op is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln82_fu_68_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ALU_operation_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_3_reg_96 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal zext_ln82_fu_85_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_36 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal add_ln82_fu_74_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_92)) then
                if ((icmp_ln82_fu_68_p2 = ap_const_lv1_0)) then 
    ...
    ALU_operation_MEM_address0 <= zext_ln82_fu_85_p1(6 - 1 downto 0);
    ...
    add_ln82_fu_74_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv6_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln82_fu_68_p2, ap_start_int)
    begin
        if (((icmp_ln82_fu_68_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln82_fu_68_p2 <= "1" when (ap_sig_allocacmp_i_3 = ap_const_lv6_32) else "0";
    zext_ln82_fu_85_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_3_reg_96),64));
end behav;

...
entity alv_MIMD_data_exe_wb_Pipeline_l_data_b is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of alv_MIMD_data_exe_wb_Pipeline_l_data_b is 
...
begin
    ...
    add_ln54_fu_105_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_7) + unsigned(ap_const_lv6_1));
    ...
    icmp_ln54_fu_99_p2 <= "1" when (ap_sig_allocacmp_i_7 = ap_const_lv6_32) else "0";
    ...
    m_axi_gmem1_WVALID <= ap_const_logic_0;
        sext_ln58_fu_139_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln6_fu_129_p4),64));

    shl_ln6_fu_111_p3 <= (ap_sig_allocacmp_i_7 & ap_const_lv2_0);
    trunc_ln6_fu_129_p4 <= add_ln58_fu_123_p2(63 downto 2);
    zext_ln58_fu_119_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln6_fu_111_p3),64));
end behav;

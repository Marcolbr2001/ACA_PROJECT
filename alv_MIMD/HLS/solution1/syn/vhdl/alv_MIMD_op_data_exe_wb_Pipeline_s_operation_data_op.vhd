...
entity alv_MIMD_op_data_exe_wb_Pipeline_s_operation_data_op is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of alv_MIMD_op_data_exe_wb_Pipeline_s_operation_data_op is 
...
begin
    ...
    add_ln112_fu_74_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_4) + unsigned(ap_const_lv6_1));
    ...
    icmp_ln112_fu_68_p2 <= "1" when (ap_sig_allocacmp_i_4 = ap_const_lv6_32) else "0";
    zext_ln112_fu_85_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_4_reg_96),64));
end behav;

...
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds i32* %%b, i64 %%3, !dbg !2 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_26_count);
  llvm_cbe_tmp__6 = (signed int *)(&llvm_cbe_b[(((signed long long )llvm_cbe_tmp__2))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__2));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load volatile i32* %%7, align 4, !dbg !2 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_27_count);
  llvm_cbe_tmp__7 = (unsigned int )*((unsigned int volatile*)llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds [50 x i32]* %%data_b, i64 0, i64 %%3, !dbg !2 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_28_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%8, i32* %%9, align 4, !dbg !2 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_29_count);
  *llvm_cbe_tmp__8 = llvm_cbe_tmp__7;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = add nsw i32 %%storemerge5, 1, !dbg !4 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_30_count);
...
llvm_cbe_tmp__33:
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load volatile i32* %%1, align 4, !dbg !4 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_40_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = sext i32 %%storemerge14.us to i64, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_54_count);
  llvm_cbe_tmp__11 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge14_2e_us);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = getelementptr inbounds [50 x i32]* %%data_a, i64 0, i64 %%15, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_55_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = load i32* %%16, align 4, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_56_count);
  llvm_cbe_tmp__13 = (unsigned int )*llvm_cbe_tmp__12;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds [50 x i32]* %%data_b, i64 0, i64 %%15, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_57_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = load i32* %%18, align 4, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_58_count);
  llvm_cbe_tmp__15 = (unsigned int )*llvm_cbe_tmp__14;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = add nsw i32 %%19, %%17, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_59_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = getelementptr inbounds [50 x i32]* %%data_result, i64 0, i64 %%15, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_60_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%20, i32* %%21, align 4, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_61_count);
  *llvm_cbe_tmp__17 = llvm_cbe_tmp__16;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = add nsw i32 %%storemerge14.us, 1, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_62_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = sext i32 %%storemerge14 to i64, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_78_count);
  llvm_cbe_tmp__19 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge14);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = getelementptr inbounds [50 x i32]* %%data_a, i64 0, i64 %%24, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_79_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = load i32* %%25, align 4, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_80_count);
  llvm_cbe_tmp__21 = (unsigned int )*llvm_cbe_tmp__20;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = getelementptr inbounds [50 x i32]* %%data_b, i64 0, i64 %%24, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_81_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = load i32* %%27, align 4, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_82_count);
  llvm_cbe_tmp__23 = (unsigned int )*llvm_cbe_tmp__22;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = sub nsw i32 %%26, %%28, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_83_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = getelementptr inbounds [50 x i32]* %%data_result, i64 0, i64 %%24, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_84_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%29, i32* %%30, align 4, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_85_count);
  *llvm_cbe_tmp__25 = llvm_cbe_tmp__24;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = add nsw i32 %%storemerge14, 1, !dbg !5 for 0x%I64xth hint within @setMem  --> \n", ++aesl_llvm_cbe_86_count);

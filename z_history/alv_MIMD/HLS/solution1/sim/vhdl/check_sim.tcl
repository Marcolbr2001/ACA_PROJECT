...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.alv_MIMD.autotvin_gmem0.dat"
         "c.alv_MIMD.autotvin_gmem1.dat"
         "c.alv_MIMD.autotvin_gmem3.dat"
         "c.alv_MIMD.autotvin_a.dat"
         "c.alv_MIMD.autotvin_b.dat"
         "c.alv_MIMD.autotvin_c.dat"
         "c.alv_MIMD.autotvin_op.dat"
         "c.alv_MIMD.autotvin_selec.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.alv_MIMD.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

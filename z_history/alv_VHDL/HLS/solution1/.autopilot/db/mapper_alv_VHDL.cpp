...
using hls::sim::Byte;
extern "C" void alv_VHDL(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int, int);
extern "C" void apatb_alv_VHDL_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c, volatile void * __xlx_apatb_param_op, int __xlx_apatb_param_selec) {
...
__xlx_op__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_op)[i]);
  ...
  // DUT call
  alv_VHDL(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data(), __xlx_op__tmp_vec.data(), __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c, __xlx_offset_byte_param_op, __xlx_apatb_param_selec);

...
module alv_VHDL_operation_Pipeline_l_operation (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln88_fu_105_p2 = (ap_sig_allocacmp_i_2 + 6'd1);
...
assign icmp_ln88_fu_99_p2 = ((ap_sig_allocacmp_i_2 == 6'd50) ? 1'b1 : 1'b0);
...
endmodule //alv_VHDL_operation_Pipeline_l_operation

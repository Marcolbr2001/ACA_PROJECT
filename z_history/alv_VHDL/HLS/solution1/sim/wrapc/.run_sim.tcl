...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "alv_VHDL.autotvin.dat"
	set constFileTvOut       "alv_VHDL.autotvout.dat"
	set constFileHdlTvIn     "alv_VHDL.autohdltvin.dat"
	set constFileHdlTvOut    "alv_VHDL.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

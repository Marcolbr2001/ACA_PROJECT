...
entity alv_VHDL_operation_Pipeline_s_operation_data_op is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of alv_VHDL_operation_Pipeline_s_operation_data_op is 
...
attribute shreg_extract : string;
    ...
    signal i_reg_96 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    add_ln101_fu_74_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv6_1));
    ...
    icmp_ln101_fu_68_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv6_32) else "0";
    zext_ln101_fu_85_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_96),64));
end behav;

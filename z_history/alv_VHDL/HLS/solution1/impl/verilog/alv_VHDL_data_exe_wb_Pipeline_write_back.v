...
module alv_VHDL_data_exe_wb_Pipeline_write_back (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [63:0] sext_ln200_fu_146_p1;
...
wire   [63:0] zext_ln200_fu_126_p1;
wire   [63:0] add_ln200_fu_130_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln197_fu_106_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln197_fu_106_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln197_fu_112_p2 = (ap_sig_allocacmp_i_6 + 6'd1);

assign add_ln200_fu_130_p2 = (zext_ln200_fu_126_p1 + c);
...
assign icmp_ln197_fu_106_p2 = ((ap_sig_allocacmp_i_6 == 6'd50) ? 1'b1 : 1'b0);
...
assign sext_ln200_fu_146_p1 = $signed(trunc_ln9_fu_136_p4);

assign shl_ln9_fu_118_p3 = {{ap_sig_allocacmp_i_6}, {2'd0}};

assign trunc_ln9_fu_136_p4 = {{add_ln200_fu_130_p2[63:2]}};

assign zext_ln200_fu_126_p1 = shl_ln9_fu_118_p3;

endmodule //alv_VHDL_data_exe_wb_Pipeline_write_back

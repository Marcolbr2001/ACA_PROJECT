...
module alv_VHDL_op_data_exe_wb_Pipeline_l_operation (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [63:0] sext_ln92_fu_139_p1;
reg   [5:0] i_fu_62;
...
wire   [63:0] zext_ln92_fu_119_p1;
wire   [63:0] add_ln92_fu_123_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln88_fu_99_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln88_fu_99_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln88_fu_105_p2 = (ap_sig_allocacmp_i_5 + 6'd1);

assign add_ln92_fu_123_p2 = (zext_ln92_fu_119_p1 + op);
...
assign icmp_ln88_fu_99_p2 = ((ap_sig_allocacmp_i_5 == 6'd50) ? 1'b1 : 1'b0);
...
assign sext_ln92_fu_139_p1 = $signed(trunc_ln_fu_129_p4);

assign shl_ln_fu_111_p3 = {{ap_sig_allocacmp_i_5}, {2'd0}};

assign trunc_ln_fu_129_p4 = {{add_ln92_fu_123_p2[63:2]}};

assign zext_ln92_fu_119_p1 = shl_ln_fu_111_p3;

endmodule //alv_VHDL_op_data_exe_wb_Pipeline_l_operation

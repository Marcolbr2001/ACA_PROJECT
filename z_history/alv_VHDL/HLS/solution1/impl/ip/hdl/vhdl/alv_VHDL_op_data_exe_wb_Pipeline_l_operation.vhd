...
entity alv_VHDL_op_data_exe_wb_Pipeline_l_operation is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of alv_VHDL_op_data_exe_wb_Pipeline_l_operation is 
...
begin
    ...
    add_ln88_fu_105_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_5) + unsigned(ap_const_lv6_1));
    ...
    icmp_ln88_fu_99_p2 <= "1" when (ap_sig_allocacmp_i_5 = ap_const_lv6_32) else "0";

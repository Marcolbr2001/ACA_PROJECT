...
HD_PWD='C:/Users/marco/Desktop/NECST/NL2/M_AXI_ALU/alv_VHDL/alv_VHDL/alv_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alv_VHDL_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alv_VHDL_design_wrapper.tcl

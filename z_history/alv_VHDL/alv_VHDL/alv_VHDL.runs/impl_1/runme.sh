...
HD_PWD='C:/Users/marco/Desktop/NECST/NL2/M_AXI_ALU/alv_VHDL/alv_VHDL/alv_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alv_VHDL_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alv_VHDL_design_wrapper.tcl -notrace

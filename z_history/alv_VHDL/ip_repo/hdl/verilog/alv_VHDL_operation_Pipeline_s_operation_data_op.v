...
module alv_VHDL_operation_Pipeline_s_operation_data_op (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln101_fu_74_p2 = (ap_sig_allocacmp_i + 6'd1);
...
assign icmp_ln101_fu_68_p2 = ((ap_sig_allocacmp_i == 6'd50) ? 1'b1 : 1'b0);

assign zext_ln101_fu_85_p1 = i_reg_96;

endmodule //alv_VHDL_operation_Pipeline_s_operation_data_op

...
if (AESL_DEBUG_TRACE)
printf("\n  call void @dec_MIMD(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 10) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_51_count);
  dec_MIMD((signed int *)llvm_cbe_tmp__8, (signed int *)llvm_cbe_tmp__9, (signed int *)llvm_cbe_tmp__10, (signed int *)llvm_cbe_tmp__11, 10u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",10u);
}
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @dec_MIMD(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 2) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_94_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @dec_MIMD(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 4) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_228_count);
  dec_MIMD((signed int *)llvm_cbe_tmp__8, (signed int *)llvm_cbe_tmp__9, (signed int *)llvm_cbe_tmp__10, (signed int *)llvm_cbe_tmp__11, 4u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",4u);
}
...
llvm_cbe_tmp__81:
if (AESL_DEBUG_TRACE)
printf("\n  call void @dec_MIMD(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 1) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_298_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @dec_MIMD(i32* %%10, i32* %%11, i32* %%12, i32* %%13, i32 3) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_314_count);
  dec_MIMD((signed int *)llvm_cbe_tmp__8, (signed int *)llvm_cbe_tmp__9, (signed int *)llvm_cbe_tmp__10, (signed int *)llvm_cbe_tmp__11, 3u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",3u);
}

...
HD_PWD='C:/Users/marco/Desktop/ALU_sys_HDL_BD/ALU_sys_HDL_BD.runs/ALU_sys_HDL_BD_auto_pc_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_sys_HDL_BD_auto_pc_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_sys_HDL_BD_auto_pc_4.tcl

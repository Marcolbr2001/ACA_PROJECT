...
HD_PWD='C:/Users/marco/Desktop/ALU_sys_HDL_BD/ALU_sys_HDL_BD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_sys_HDL_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_sys_HDL_BD_wrapper.tcl -notrace

...
set C_modelArgList {
	...
	{ c int 64 regular  }
	{ ALU_operation_MEM int 32 regular {array 100 { 2 3 } 1 1 }  }
...
set portList { 
	...
	{ ALU_operation_MEM_address0 sc_out sc_lv 7 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ALU_operation_MEM_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "ALU_operation_MEM", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	ALU_operation_MEM { ap_memory {  { ALU_operation_MEM_address0 mem_address 1 7 }  { ALU_operation_MEM_ce0 mem_ce 1 1 }  { ALU_operation_MEM_we0 mem_we 1 1 }  { ALU_operation_MEM_d0 mem_din 1 32 }  { ALU_operation_MEM_q0 mem_dout 0 32 } } }

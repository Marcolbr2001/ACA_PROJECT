set moduleName op_data_exe_wb_Pipeline_s_operation_data_op
set isTopModule 0
...
set C_modelName {op_data_exe_wb_Pipeline_s_operation_data_op}
set C_modelType { void 0 }
set C_modelArgList {
	{ ALU_operation_MEM int 32 regular {array 100 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ ALU_operation_MEM_address0 sc_out sc_lv 7 signal 0 } 
...
set Spec2ImplPortList { 
	ALU_operation_MEM { ap_memory {  { ALU_operation_MEM_address0 mem_address 1 7 }  { ALU_operation_MEM_ce0 mem_ce 1 1 }  { ALU_operation_MEM_we0 mem_we 1 1 }  { ALU_operation_MEM_d0 mem_din 1 32 } } }

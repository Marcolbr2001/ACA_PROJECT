...
# 21 "C:/Xilinx/Vitis_HLS/2023.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 3
extern "C" {
...
{
 clear_RAM_op : for(int i = 0; i < 100; i++)
   {
...
void load_op(volatile int op[], hls::stream<int>&ALU_operation)
{
 ...
 l_operation: for(int i = 0; i < 100; i++)
 {
#pragma HLS PIPELINE II=1
...
void store_op(hls::stream<int>&ALU_operation, int ALU_operation_MEM[])
{
 ...
 s_operation_data_op: for(int i = 0; i < 100; i++)
 {
#pragma HLS PIPELINE II=1
...
{
 write_back: for(int i = 0; i < 100; i++)
 {
#pragma HLS PIPELINE II=1
...
#line 17 "C:/Users/lotto/Desktop/Alveare/M_AXI_ALU/100/ALU_sys_HDL/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=ALU_sys_HDL
# 191 "core.cpp"

#line 7 "C:/Users/lotto/Desktop/Alveare/M_AXI_ALU/100/ALU_sys_HDL/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=ALU_sys_HDL
# 191 "core.cpp"
...
#pragma HLS INTERFACE mode=m_axi port=a bundle=gmem0 depth=100 offset=slave
#pragma HLS INTERFACE mode=m_axi port=b bundle=gmem1 depth=100 offset=slave
#pragma HLS INTERFACE mode=m_axi port=c bundle=gmem2 depth=100 offset=slave
#pragma HLS INTERFACE mode=m_axi port=op bundle=gmem3 depth=100 offset=slave

 static hls::stream<int> data_a("data_a");
#pragma HLS STREAM variable=data_a depth=100


 static hls::stream<int> data_b("data_b");
#pragma HLS STREAM variable=data_b depth=100


 static hls::stream<int> data_result("data_result");
#pragma HLS STREAM variable=data_result depth=100


 static hls::stream<int> ALU_operation("ALU_operation");
#pragma HLS STREAM variable=ALU_operation depth=100


 static int ALU_operation_MEM[100] = {0};
 int data_result_MEM[100] = {0};

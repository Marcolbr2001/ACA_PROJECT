...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ALU_sys_HDL.autotvin_gmem0.dat"
         "c.ALU_sys_HDL.autotvin_gmem1.dat"
         "c.ALU_sys_HDL.autotvin_gmem3.dat"
         "c.ALU_sys_HDL.autotvin_a.dat"
         "c.ALU_sys_HDL.autotvin_b.dat"
         "c.ALU_sys_HDL.autotvin_c.dat"
         "c.ALU_sys_HDL.autotvin_op.dat"
         "c.ALU_sys_HDL.autotvin_selec.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ALU_sys_HDL.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

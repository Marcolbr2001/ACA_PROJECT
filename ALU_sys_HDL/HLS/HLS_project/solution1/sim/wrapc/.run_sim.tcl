...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ALU_sys_HDL.autotvin.dat"
	set constFileTvOut       "ALU_sys_HDL.autotvout.dat"
	set constFileHdlTvIn     "ALU_sys_HDL.autohdltvin.dat"
	set constFileHdlTvOut    "ALU_sys_HDL.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

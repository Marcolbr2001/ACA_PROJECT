...
if {[file isfile alv_VHDL.autotvin.dat]} {
	file delete -force alv_VHDL.autotvin.dat
}

if {[file isfile alv_VHDL.autotvout.dat]} {
	file delete -force alv_VHDL.autotvout.dat
}

...
#pragma HLS PIPELINE II=1
 ...
 int a,b;
  ...
  switch(ALU_operation_MEM[i])
  {
   ...
   case 0 :
    data_result.write(a + 27);
   break;

   case 1 :
    data_result.write(b + 27);
   break;
...
__attribute__((sdx_kernel("alv_VHDL", 0))) void alv_VHDL(volatile int* a,volatile int* b, volatile int* c,volatile int* op, int selec) {
#line 15 "C:/Users/lotto/Desktop/Alveare/M_AXI_ALU/alv_VHDL/alv_VHDL/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=alv_VHDL
# 222 "core.cpp"

...
entity alv_VHDL_Block_entry1_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of alv_VHDL_Block_entry1_proc is 
...
attribute shreg_extract : string;
    ...
    signal grp_op_data_exe_wb_fu_112_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal grp_data_exe_wb_fu_142_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal grp_operation_fu_166_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal grp_reset_fu_178_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    component alv_VHDL_op_data_exe_wb IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component alv_VHDL_data_exe_wb IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component alv_VHDL_operation IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component alv_VHDL_Block_entry1_proc_ALU_operation_MEM_RAM_AUTO_1R1W IS
    generic (
        DataWidth : INTEGER;
    ...
    component alv_VHDL_fifo_w32_d50_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ALU_operation_MEM_U : component alv_VHDL_Block_entry1_proc_ALU_operation_MEM_RAM_AUTO_1R1W
    generic map (
        DataWidth => 32,
        AddressRange => 50,
        AddressWidth => 6)
    ...
    grp_op_data_exe_wb_fu_112 : component alv_VHDL_op_data_exe_wb
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_data_exe_wb_fu_142 : component alv_VHDL_data_exe_wb
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_operation_fu_166 : component alv_VHDL_operation
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reset_fu_178 : component alv_VHDL_reset
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ALU_operation_fifo_U : component alv_VHDL_fifo_w32_d50_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    data_a_fifo_U : component alv_VHDL_fifo_w32_d50_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    data_b_fifo_U : component alv_VHDL_fifo_w32_d50_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    data_result_fifo_U : component alv_VHDL_fifo_w32_d50_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,

...
architecture behav of alv_VHDL_reset is 
...
attribute shreg_extract : string;
    ...
    signal grp_reset_Pipeline_clear_RAM_op_fu_46_ALU_operation_MEM_address0 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    component alv_VHDL_reset_Pipeline_clear_FIFO_a IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component alv_VHDL_reset_Pipeline_clear_FIFO_b IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component alv_VHDL_reset_Pipeline_clear_ALU_op IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component alv_VHDL_reset_Pipeline_clear_RAM_op IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_reset_Pipeline_clear_FIFO_a_fu_28 : component alv_VHDL_reset_Pipeline_clear_FIFO_a
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reset_Pipeline_clear_FIFO_b_fu_34 : component alv_VHDL_reset_Pipeline_clear_FIFO_b
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reset_Pipeline_clear_ALU_op_fu_40 : component alv_VHDL_reset_Pipeline_clear_ALU_op
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reset_Pipeline_clear_RAM_op_fu_46 : component alv_VHDL_reset_Pipeline_clear_RAM_op
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,

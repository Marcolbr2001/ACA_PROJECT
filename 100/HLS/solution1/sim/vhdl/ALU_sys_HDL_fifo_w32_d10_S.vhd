...
entity ALU_sys_HDL_fifo_w32_d10_S is 
    generic (
...
architecture rtl of ALU_sys_HDL_fifo_w32_d10_S is

    component ALU_sys_HDL_fifo_w32_d10_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 10);
...
begin
----------------------- Instantiation -----------------------
    U_ALU_sys_HDL_fifo_w32_d10_S_ShiftReg : ALU_sys_HDL_fifo_w32_d10_S_ShiftReg
    generic map (
...
entity ALU_sys_HDL_fifo_w32_d10_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 10);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end ALU_sys_HDL_fifo_w32_d10_S_ShiftReg;

architecture rtl of ALU_sys_HDL_fifo_w32_d10_S_ShiftReg is

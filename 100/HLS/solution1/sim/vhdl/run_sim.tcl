...
if {[file isfile ALU_sys_HDL.autotvin.dat]} {
	file delete -force ALU_sys_HDL.autotvin.dat
}

if {[file isfile ALU_sys_HDL.autotvout.dat]} {
	file delete -force ALU_sys_HDL.autotvout.dat
}

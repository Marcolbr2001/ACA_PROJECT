set SynModuleInfo {
  ...
  {SRCNAME Block_entry1_proc MODELNAME Block_entry1_proc RTLNAME ALU_sys_HDL_Block_entry1_proc
    SUBMODULES {
      ...
      {MODELNAME ALU_sys_HDL_fifo_w32_d100_A RTLNAME ALU_sys_HDL_fifo_w32_d100_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME data_a_U}
      {MODELNAME ALU_sys_HDL_fifo_w32_d100_A RTLNAME ALU_sys_HDL_fifo_w32_d100_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME data_b_U}
      {MODELNAME ALU_sys_HDL_fifo_w32_d100_A RTLNAME ALU_sys_HDL_fifo_w32_d100_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME ALU_operation_U}
      {MODELNAME ALU_sys_HDL_fifo_w32_d100_A RTLNAME ALU_sys_HDL_fifo_w32_d100_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME data_result_U}
    }
  }

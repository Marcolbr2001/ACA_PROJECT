set moduleName data_exe_wb_Pipeline_exe
set isTopModule 0
...
set C_modelName {data_exe_wb_Pipeline_exe}
set C_modelType { void 0 }
set C_modelArgList {
	{ ALU_operation_MEM int 32 regular {array 100 { 1 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_32s_32s_32_36_1_U43", "Parent" : "0"},
...
set Spec2ImplPortList { 
	ALU_operation_MEM { ap_memory {  { ALU_operation_MEM_address0 mem_address 1 7 }  { ALU_operation_MEM_ce0 mem_ce 1 1 }  { ALU_operation_MEM_q0 in_data 0 32 } } }

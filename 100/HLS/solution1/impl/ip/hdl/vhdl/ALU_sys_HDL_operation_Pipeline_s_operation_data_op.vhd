...
entity ALU_sys_HDL_operation_Pipeline_s_operation_data_op is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ALU_sys_HDL_operation_Pipeline_s_operation_data_op is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln94_fu_68_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ALU_operation_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_reg_96 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal zext_ln94_fu_85_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_1_fu_36 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal add_ln94_fu_74_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln94_fu_68_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_1_fu_36 <= add_ln94_fu_74_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_1_fu_36 <= ap_const_lv7_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    ALU_operation_MEM_address0 <= zext_ln94_fu_85_p1(7 - 1 downto 0);
    ...
    ALU_operation_MEM_d0 <= ALU_operation_dout;

    ALU_operation_MEM_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    add_ln94_fu_74_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv7_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln94_fu_68_p2)
    begin
        if (((icmp_ln94_fu_68_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln94_fu_68_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv7_64) else "0";
    zext_ln94_fu_85_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_96),64));
end behav;

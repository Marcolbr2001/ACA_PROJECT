...
HD_PWD='C:/Users/lotto/Desktop/Alveare/M_AXI_ALU/100/Vivado/ALU_sys_HDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_sys_HDL_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_sys_HDL_design_wrapper.tcl

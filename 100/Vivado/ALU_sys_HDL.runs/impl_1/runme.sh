...
HD_PWD='C:/Users/lotto/Desktop/Alveare/M_AXI_ALU/100/Vivado/ALU_sys_HDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_sys_HDL_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_sys_HDL_design_wrapper.tcl -notrace

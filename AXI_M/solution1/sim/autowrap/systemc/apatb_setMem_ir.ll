...
define void @apatb_setMem_ir(i32* noalias nocapture nonnull readonly "maxi" %a, i32* noalias nocapture nonnull readonly "maxi" %b, i32* noalias nocapture nonnull "maxi" %c, i32* noalias nocapture nonnull readonly %op) local_unnamed_addr #0 {
entry:
  %a_copy = alloca [1 x i32], align 512
  %b_copy = alloca [1 x i32], align 512
  %c_copy = alloca [1 x i32], align 512
  %op_copy = alloca i32, align 512
  %0 = bitcast i32* %a to [1 x i32]*
  %1 = bitcast i32* %b to [1 x i32]*
  %2 = bitcast i32* %c to [1 x i32]*
  call fastcc void @copy_in([1 x i32]* nonnull %0, [1 x i32]* nonnull align 512 %a_copy, [1 x i32]* nonnull %1, [1 x i32]* nonnull align 512 %b_copy, [1 x i32]* nonnull %2, [1 x i32]* nonnull align 512 %c_copy, i32* nonnull %op, i32* nonnull align 512 %op_copy)
  ...
  call void @apatb_setMem_hw(i32* %3, i32* %4, i32* %5, i32* %op_copy)
  call void @copy_back([1 x i32]* %0, [1 x i32]* %a_copy, [1 x i32]* %1, [1 x i32]* %b_copy, [1 x i32]* %2, [1 x i32]* %c_copy, i32* %op, i32* %op_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_in([1 x i32]* noalias readonly, [1 x i32]* noalias align 512, [1 x i32]* noalias readonly, [1 x i32]* noalias align 512, [1 x i32]* noalias readonly, [1 x i32]* noalias align 512, i32* noalias readonly, i32* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([1 x i32]* noalias, [1 x i32]* noalias readonly align 512, [1 x i32]* noalias, [1 x i32]* noalias readonly align 512, [1 x i32]* noalias, [1 x i32]* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([1 x i32]* noalias, [1 x i32]* noalias readonly align 512, [1 x i32]* noalias, [1 x i32]* noalias readonly align 512, [1 x i32]* noalias, [1 x i32]* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a1i32([1 x i32]* %4, [1 x i32]* align 512 %5)
  ret void
}
...
entry:
  ...
  call void @copy_out([1 x i32]* null, [1 x i32]* %4, [1 x i32]* null, [1 x i32]* %5, [1 x i32]* null, [1 x i32]* %6, i32* null, i32* %3)
  ...
  call void @copy_in([1 x i32]* null, [1 x i32]* %4, [1 x i32]* null, [1 x i32]* %5, [1 x i32]* null, [1 x i32]* %6, i32* null, i32* %3)
  ret void
}

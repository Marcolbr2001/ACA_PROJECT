...
module setMem_setMem_Pipeline_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [5:0] loop_index3_load_reg_125;
reg   [5:0] loop_index3_load_reg_125_pp0_iter1_reg;
reg   [31:0] gmem2_addr_read_reg_134;
wire   [63:0] loop_index3_cast_fu_109_p1;
reg   [5:0] loop_index3_fu_46;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond129_fu_86_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index3_fu_46 <= empty_fu_92_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index3_fu_46 <= 6'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond129_fu_86_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign buff3_address0 = loop_index3_cast_fu_109_p1;

assign buff3_d0 = gmem2_addr_read_reg_134;

assign empty_fu_92_p2 = (ap_sig_allocacmp_loop_index3_load + 6'd1);

assign exitcond129_fu_86_p2 = ((ap_sig_allocacmp_loop_index3_load == 6'd50) ? 1'b1 : 1'b0);
...
endmodule //setMem_setMem_Pipeline_3

...
module setMem_setMem_Pipeline_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] buff3_load_reg_140;
wire   [63:0] loop_index_cast_fu_103_p1;
wire    ap_block_pp0_stage0_01001;
reg   [5:0] loop_index_fu_48;
wire   [5:0] empty_fu_97_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond7_fu_91_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_fu_48 <= empty_fu_97_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_fu_48 <= 6'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond7_fu_91_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign buff3_address0 = loop_index_cast_fu_103_p1;

assign empty_fu_97_p2 = (ap_sig_allocacmp_loop_index_load + 6'd1);

assign exitcond7_fu_91_p2 = ((ap_sig_allocacmp_loop_index_load == 6'd50) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_WDATA = buff3_load_reg_140;
...
endmodule //setMem_setMem_Pipeline_5
